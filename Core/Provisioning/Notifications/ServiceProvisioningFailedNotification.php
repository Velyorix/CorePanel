...
/**
 * Mail template when provisioning fails.
 */
class ServiceProvisioningFailedNotification extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject(__('Provisioning failed: :service', ['service' => $serviceLabel]))
            ->markdown('mail.provisioning.failed', [
