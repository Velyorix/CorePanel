...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Reset password — {{ config('corepanel.name') }}</title>
        ...
        <main class="flex min-h-screen items-center justify-center px-4">
            <div class="w-full max-w-md rounded-xl border border-zinc-200 bg-white p-8 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
                <div class="mb-8 text-center">
                    ...
                    <p class="mt-2 text-sm text-zinc-500 dark:text-zinc-400">Choose a new password</p>
                </div>
                ...
                <p class="mt-6 text-center text-sm text-zinc-500 dark:text-zinc-400">
                    <a href="{{ route('login') }}" class="font-medium text-zinc-900 hover:underline dark:text-zinc-100">Back to sign in</a>
                </p>
            </div>
        </main>
    </body>
