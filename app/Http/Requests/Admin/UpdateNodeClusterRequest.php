...
class UpdateNodeClusterRequest extends FormRequest
{
    public function authorize(): bool
    {
        $cluster = $this->route('nodeCluster');

        return $cluster instanceof NodeCluster
            && ($this->user()?->can('update', $cluster) ?? false);
    }
